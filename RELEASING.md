...
| File | Purpose |
|------|---------|
| [`bundle-manifest.json`](bundle-manifest.json) | Consumer `artifactVersion` + `coreVersion` |
| [`Public/datasets/bundle-manifest.json`](Public/datasets/bundle-manifest.json) | Release folder index + `dataRevision` per SemVer |
| [`vendor/core/VERSION`](vendor/core/VERSION) | Core engine version |
