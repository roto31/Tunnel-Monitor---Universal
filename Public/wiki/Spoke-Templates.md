...
Optional **remote-site** monitors that complement hub-side [[UniFi-Gateway-Monitor]] and [[macOS-Monitor]].

**WAN Guard stays on the hub only** — do not install [wan-guard](https://github.com/roto31/UniFi-Tunnel-Monitor/tree/main/unifi/wan-guard) on the spoke.

See [[Spoke-Monitoring]] for topology and dedup notes.
...
Every value uses `REPLACE_WITH_*` placeholders. See [[Placeholders-Reference]].
