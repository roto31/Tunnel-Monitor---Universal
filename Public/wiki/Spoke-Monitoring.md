...
- [[UniFi-Gateway-Monitor]] on the **remote gateway**
- [[macOS-Monitor]] on an optional **remote LAN Mac**
...
Templates: [[Spoke-Templates]] (`config.env.template` + deploy scripts).
...
- [[Architecture]] — hub dual-monitor design
- [[Implementation-Guide]] — full install phases
- [[Spoke-Templates]] — sanitized spoke config templates
