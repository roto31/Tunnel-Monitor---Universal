...
- **A SwiftBar menu-bar status indicator** that reads the daemon's state file
  (Mac side only).
...
> a clearly-labeled placeholder. See [[Placeholders-Reference]] for
...
├── mac/                     # macOS side (launchd + SwiftBar + app)
│   ├── README.md
│   ├── install.sh
│   └── payload/ ...
...
See [[Architecture]] for the full set of
...
- [[Implementation-Guide]] — full replication checklist
...
[[Placeholders-Reference]] for the full surface area you must
