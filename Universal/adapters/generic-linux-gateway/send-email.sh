#!/bin/bash
# =============================================================================
# send-email.sh - authenticated SMTP submission for the Linux tunnel monitor
# =============================================================================
...
# configured SUBJECT_PREFIX (default "[LINUX]") so the operator can tell at a
...
SUBJECT_PREFIX="${SUBJECT_PREFIX:-[LINUX]}"
